<?php
$_frm = & new Form_bv(array('method'=>'POST', 'action'=>'', 'name'=>'frm_rbac_actions'));


$_frm->Assign('<!TITLE!>', '<div class="hdr">Actions Form:</div>');

// INPUT ---------
$_frm->AssignInput('<NAME>', 'name', array('type'=>'text',  'size'=>'30', 'class'=>'inp', 'info'=>'', 'maxlength'=>50 ));
$_frm->SetInputRules('name', array('table'=>'rbac_actions', 'alphanum', 'required', 'unique', 'maxlength'=>50));
// INPUT ---------
$_frm->AssignInput('<DESCRIPTION>', 'description', array('type'=>'textarea', 'cols'=>'40', 'rows'=>'10','class'=>'inp', 'info'=>'' ));
$_frm->SetInputRules('description', array('table'=>'rbac_actions'));
