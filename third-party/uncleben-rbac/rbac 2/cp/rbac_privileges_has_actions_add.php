...
/**
  * Adding functionality for table rbac_privileges_has_actions
  *
  **/
...
class rbac_privileges_has_actions_add extends securePage_bv
{

	Function rbac_privileges_has_actions_add($arrAttr)
	{
		...
		$this->Assign('<TITLE>', 'Add new rbac_privileges_has_actions');
